                ...
                <div>
                  <button @click="open = !open" type="button" class="flex rounded-full bg-white text-sm focus:outline-none" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <span class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-emerald-100">
                      <span title="<?php echo $user_obj->name;?>" class="font-medium leading-none text-emerald-700"><?php echo substr($user_obj->name, 0, 2);?></span>
                    </span>
                  </button>
                </div>
          ...
          <div class="sm:rounded-lg">
            ...
            ?>
              ...
              <div class="mt-4 text-sm text-gray-500">
                ...
                <!-- hideden field -->
                <input type="hidden" name="transaction_type" value="<?php echo TransactionType::WITHDRAW;?>" >
                  <!-- Input Field -->
                  <div class="relative mt-2 rounded-md">
                    ...
                    <input type="number" name="amount" id="amount" value="<?php //echo Input::get('amount'); ?>" class="block w-full ring-0 outline-none text-xl pl-4 py-2 sm:pl-8 text-gray-800 border-b border-b-emerald-500 placeholder:text-gray-400 sm:text-4xl" placeholder="0.00" required />
                  </div>
